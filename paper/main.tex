...
educational gap in 2015.  The present artefact differs in being
SDR-based (hence covering RF, antennas, and capture pipelines in
addition to frame analysis), fully open-source, and end-to-end
through to a playable video file --- but the pedagogical intent
is identical and we view our work as a direct successor to that
effort, eleven years later, made possible by the maturity of
