...
PPS NAL units in the object-descriptor (\texttt{tid}=0x04)
...
PID~\texttt{0x112}~--- a stream-type restriction permitted by
TS~102\,428~\cite{etsi102428}.  Our locator scans the SD byte stream for the
